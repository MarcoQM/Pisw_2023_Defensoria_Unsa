    ...
    return (
        <div className="sticky top-0 w-full z-100">
            <div className=" bg-granate-900 text-white p-4 flex justify-between items-center  ">
                ...
                <div className="flex items-center text-white rounded text-sm  sm:text-xl">
                    <FaBell className='text-xl mr-2 hover:text-gris cursor-pointer' />
                    <span className=" text-sm  sm:text-xl font-semibold">{getLocalUserName()}</span>
                    <button className=" hover:underline px-1 text-sm m-2 sm:text-lg"
