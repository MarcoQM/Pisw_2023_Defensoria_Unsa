...
export function RegistroIncidencias() {
  ...
  const [correoPlaceholder, setCorreoPlaceholder] = useState("usuario@unsa.edu.pe");
  ...
  return (
    ...
    <div className="Relative" >
      <div className="absolute top-50 right-40">
        ...
        <div className="bg-white rounded-lg p-4 w-80 h-90 mx-auto top-80 mt-8 hidden 2xl:block sm:w-40 sm:h-40 md:w-64 md:h-64 lg:w-80 lg:h-80 xl:w-96 xl:h-96">
      ...
      <div className="max-w-2xl mx-auto bg-grisclaro  rounded-lg shadow-lg p-10 lg:ml-40 lg:mt-10 ">
        <h4 className="text-granate text-3xl font-bold text-center mb-4">FORMULARIO DE ATENCIÓN</h4>
        ...
        <form onSubmit={onSubmit} >
          <div className="flex flex-wrap -mx-3">
            ...
            <div className="w-full md:w-1/6 px-3 mb-3">
              <div
                className="ml-2 w-8 h-8 bg-granate-900 text-white rounded-full flex items-center justify-center cursor-pointer"
                onClick={() => {
                  toast("El rol es la actividad que cumple dentro o fuera de la universidad, postulante universitario, madre o padre del estudiante, etc.");
                }}
              >
          ...
          <div style={{ display: "flex" }}>
            {["Estudiante", "Egresado", "Docente", "Administrativo", "Otros"].map((rol) => (
              <div key={rol} className=" mx-2 mb-6">
                <label>
                  <input
                    type="radio"
                    name="rol"
          ...
          {selectedRol === "Otros" && (
            <div className="relative mb-6">
              ...
              <input
                type="text"
                placeholder="Detalle"
                className="bg-white border border-white p-3 rounded-lg block w-full mb-3"
                {...register("detalle")}
          ...
          <div className="w-64 relative  mb-6">
            <div className="w-64 relative mb-6">
              ...
              <select
                className="block w-full bg-white border border-gray-300 hover:border-gray-500 p-2 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
                name="sede"
          ...
          <div className=" relative  mb-6">
            ...
            <input
              type="text"
              placeholder="Av. Virgen del Pilar s/n, Área de Sociales de la UNSA."
          ...
          <div className=" relative  ">
            ...
            <p className="text-sm">(Debe aclararse si se persigue modificar decisiones ya adoptadas o bien alertar de un supuesto mal funcionamiento con objeto de solventar el problema en el futuro) </p>
          </div>

          <div className="relative  mb-6">
            <textarea
              type="text"
              className="appearance-none block w-full bg-white border border-gris hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline h-20 "
              placeholder="Solicito..." {...register("solicita", { required: true })}
            />
          ...
          <div className=" relative  ">
            ...
            <p className="text-sm">(Debe concretarse con suficiente claridad el hecho o hechos que originan la solicitud, así como el motivo y alcance de la pretensión que se plantea.) </p>
          </div>

          <div className="relative  mb-6">
            <textarea
              type="text"
              className="appearance-none block w-full bg-white border border-gris hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline h-28 "
          ...
          <div className="relative  mb-6">
            <label className="block font-bold" htmlFor="adjuntos">Archivos Adjuntos</label>
            <p className="text-sm">Adjunta hasta un máximo de 5 archivos. Cada archivo deberá pesar como máximo 2MB.</p>

            <input
              type="file"
              id="adjuntos"
              name="adjuntos"
              className="bg-white border border-gray-300 p-3 rounded-lg block w-full mb-3"
              multiple
          ...
          <div className="relative  mb-6">
            ...
            />
            <label htmlFor="miCheckbox" className="ml-2 text-sm">
              Autoriza Ud. ser notificado a través de su correo Electronico
              <span className="text-sm text-red-500 font-bold ml-1 text-sm">*necesario*</span>
            </label>
          </div>

          <div className="relative mb-6">
            <p className="text-sm font-semibold">Apenas se pueda estaremos en contacto contigo. Lamentamos el incidente.</p>
