        ...
        <div className="flex">
            ...
            <div className="ml-14 p-4 w-full">
                <div className="max-w-7xl mx-auto bg-grisclaro rounded-lg shadow-lg p-10 my-10"> {/* cuadro gris*/}
                    <h2 className="text-granate text-3xl font-bold text-center mb-4">REPORTES GRÁFICOS</h2>
                

                    <a className="text-black text-2xl font-bold text-center mb-4">Reportes gráficos</a>
                    {/* Tabla de Datos */}
